...
I addressed their feedback by updating the docstring example to use nested astronomical data with expected output, and adding from_pyarrow to the API reference documentation.
